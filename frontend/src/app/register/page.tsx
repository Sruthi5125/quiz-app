...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data) {
        const msgs = Object.values(data).flat().map((v: any) =>
  ...
  return (
    <main className="min-h-screen flex items-center justify-center p-4"
      ...
      <div className="absolute top-20 right-1/4 w-72 h-72 bg-violet-600 rounded-full opacity-20 blur-3xl pointer-events-none" />
      <div className="absolute bottom-20 left-1/4 w-72 h-72 bg-indigo-600 rounded-full opacity-20 blur-3xl pointer-events-none" />
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-purple-300 mt-1 text-sm">Create your free account</p>
        </div>
